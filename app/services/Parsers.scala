...
object Parsers {
  ...
  * */
  ...
  def DBLP (search: JsValue, jsValue: JsValue) : Publication = Publication (
    if (search == null ) "" else (search \ "name").as[String],
    if (search == null ) "" else (search \ "affiliation").as[String],
    (jsValue \ "title").asOpt[JsValue].map(value => value.as[String]),
    (jsValue \ "writers").asOpt[JsValue].map(value => value.as[String]),
    None,
    (jsValue \ "year").asOpt[JsValue].map(value => value.as[Int]),
    None,
    None
    ...
    def microsoft (search: JsValue, jsValue: JsValue) : Publication = Publication (
    if (search == null ) "" else (search \ "name").as[String],
    if (search == null ) "" else (search \ "affiliation").as[String],
    (jsValue \ "Ti").asOpt[JsValue].map(value => value.as[String]),
    None,
    None,
    (jsValue \ "Y").asOpt[JsValue].map(value => value.as[Int]),
    None,
    None
    ...
    def youtube(search: JsValue, jsValue: JsValue) : Publication = Publication (
    if (search == null ) "" else (search \ "name").as[String],
    if (search == null ) "" else (search \ "affiliation").as[String],
    (jsValue \ "snippet" \ "title").asOpt[JsValue].map(value => value.as[String]),
    None,
    None,
    None,
    None,
