...
object Search {
  ...
  def searchPublication(search: Search) : Array[List[Publication]] = {
    val driver = "org.postgresql.Driver"
    val url = "jdbc:postgresql://localhost/zweng4"
    val username = "zweng4"
    val password = ""
   ...
   // try {
    ...
    lst = LeanredPairwiseMergability.link(lst, "Publication").map(rec => rec.asInstanceOf[Publication])
    val rel = BinaryClassification.predictRelevance(lst, "Publication", search)
  ...
  def searchGrant(search: Search) : Array[List[Grant]] = {
    val driver = "org.postgresql.Driver"
    val url = "jdbc:postgresql://localhost/zweng4"
    val username = "zweng4"
    val password = ""
   ...
   // try {
    ...
    lst = LeanredPairwiseMergability.link(lst, "Grant").map(rec => rec.asInstanceOf[Grant])
    val rel = BinaryClassification.predictRelevance(lst, "Grant", search)
  ...
  def searchPatent(search: Search) : Array[List[Patent]] = {
    val driver = "org.postgresql.Driver"
    val url = "jdbc:postgresql://localhost/zweng4"
    val username = "zweng4"
    val password = ""
   ...
   // try {
    ...
    lst = LeanredPairwiseMergability.link(lst, "Patent").map(rec => rec.asInstanceOf[Patent])
    val rel = BinaryClassification.predictRelevance(lst, "Patent", search)
